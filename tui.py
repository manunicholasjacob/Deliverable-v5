...
def main(stdscr):
    ...
    summary_window = curses.newwin(20, 60, 1, 1)
    display_box(summary_window, 1, 1, 20, 60, "Test Summary")
    ...
    try:
        ...
        summary_window.addstr(4, 2, f"Total Time Taken: {total_time:.2f} seconds")
